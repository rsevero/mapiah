...
10. Always include a "Signed-off-by: My Name <my.email@example.com>" (use git to get name and email if necessary) line and a "Co-Authored-By: MODEL <email>" line in your commit message.
