...
void main() {
  ...
  group('command: MPEditLineTypeCommand', () {
    setUp(() {
      ...
      test(
        ...
        () async {
          try {
            ...
            final int lineMPID = parsedFile.getLines().first.mpID;

            final MPCommand setPLATypeCommand = MPCommandFactory.editLinesType(
              newLineType: THLineType.fromString(
                success['newPLAType'] as String,
              ),
              unknownPLAType: THLineType.unknownPLATypeFromString(
                success['newPLAType'] as String,
              ),
              lineMPIDs: [lineMPID],
            );
