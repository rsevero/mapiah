...
void main() {
  ...
  group('XVISkethLines', () {
    ...
    final XVISketchLine xviSketchLineGray = XVISketchLine.colorFromString(
      color: 'gray',
      start: THPositionPart.fromStrings(
        xAsString: '-1097.48',
        yAsString: '-1886.46',
    ...
    final xviSketchLineGreen = XVISketchLine.colorFromString(
      color: 'green',
      start: THPositionPart.fromStrings(
        xAsString: '-1380.94',
        yAsString: '-841.18',
    ...
    final XVISketchLine xviSketchLineBlack = XVISketchLine.colorFromString(
      color: 'black',
      start: THPositionPart.fromStrings(
        xAsString: '-1062.05',
        yAsString: '-687.64',
