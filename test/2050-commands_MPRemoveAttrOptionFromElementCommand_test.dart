...
void main() {
  ...
  group('command: MPRemoveAttrOptionFromElementCommand', () {
    setUp(() {
    ...
    const successes = [
      {
        'file': '2025-10-16-001-line_with_custom_attr.th2',
        'length': 8,
        'encoding': 'UTF-8',
        'lineID': 'blaus',
      ...
      test(
        ...
        () async {
          try {
            ...
            /// Execution: taken from TH2FileEditUserInteractionController.prepareUnsetAttrOption()
