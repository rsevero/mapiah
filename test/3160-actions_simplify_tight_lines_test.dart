  ...
  group('actions: simplify tight lines using provided pre/pos files', () {
    ...
    test(
      ...
      () async {
        ...
        final line = controller.th2File.getLines().first;
        ...
        final String afterSerialized = writer.serialize(controller.th2File);

        expect(afterSerialized, expectedPosSerialized);

        // Undo and verify original restored
        controller.undo();
        final String undoneSerialized = writer.serialize(controller.th2File);
