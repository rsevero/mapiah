...
class MPDialogAux {
  ...
  static Future<void> checkForUpdates() async {
    ...
    try {
      ...
      final int lastNewVersionCheckMS =
          prefs.getInt(MPSetting.Internal_LastNewVersionCheckMS.name) ?? 0;
      ...
      prefs.setInt(
        MPSetting.Internal_LastNewVersionCheckMS.name,
  ...
  static Future<void> runTherion(BuildContext context) async {
    ...
    final String configuredExecutablePath = mpLocator.mpSettingsController
        .getString(MPSetting.Main_TherionExecutablePath)
        .trim();
