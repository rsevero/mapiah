...
mixin _$MPGeneralController on MPGeneralControllerBase, Store {
  ...
  List<MPCopyElementWithChildren>? get clipboard {
    _$_clipboardAtom.reportRead();
    return super._clipboard;
  }

  @override
  List<MPCopyElementWithChildren>? get _clipboard => clipboard;

  @override
  set _clipboard(List<MPCopyElementWithChildren>? value) {
    _$_clipboardAtom.reportWrite(value, super._clipboard, () {
      super._clipboard = value;
    });
  }
  ...
  void setClipboard(List<MPCopyElementWithChildren>? copyResult) {
    final _$actionInfo = _$MPGeneralControllerBaseActionController.startAction(
      name: 'MPGeneralControllerBase.setClipboard',
    );
    try {
      return super.setClipboard(copyResult);
    } finally {
      _$MPGeneralControllerBaseActionController.endAction(_$actionInfo);
    }
  }
