...
part of 'th2_file_edit_command_option_controller.dart';
...
mixin _$TH2FileEditCommandOptionController
    on TH2FileEditCommandOptionControllerBase, Store {
  late final _$_thFileAtom = Atom(
      name: 'TH2FileEditCommandOptionControllerBase._thFile', context: context);
  ...
  late final _$_th2FileEditControllerAtom = Atom(
      name: 'TH2FileEditCommandOptionControllerBase._th2FileEditController',
      context: context);
