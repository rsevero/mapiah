...
class THAltitudeValueCommandOptionMapper
  ...
  static THFile _$thFile(THAltitudeValueCommandOption v) => v.thFile;
  static const Field<THAltitudeValueCommandOption, THFile> _f$thFile =
      Field('thFile', _$thFile);
  static int _$parentMapiahID(THAltitudeValueCommandOption v) =>
      v.parentMapiahID;
  static const Field<THAltitudeValueCommandOption, int> _f$parentMapiahID =
