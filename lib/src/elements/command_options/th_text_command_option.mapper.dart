...
class THTextCommandOptionMapper extends ClassMapperBase<THTextCommandOption> {
  ...
  static const Field<THTextCommandOption, dynamic> _f$parentMapiahID =
  ...
  static const Field<THTextCommandOption, dynamic> _f$optionType =
  ...
  static THTextCommandOption _instantiate(DecodingData data) {
    return THTextCommandOption.withExplicitParameters(
