      ...
      builder: (_) {
        ...
        final bool isInteractiveLineSimplificationDialogOpen =
            th2FileEditController
                .isInteractiveLineSimplificationDialogOpen
                .value;
            ...
            TH2FileEditStateContextFABCategoryRow(
              buttons: <Widget>[
                TH2FileEditStateContextFABButton(
                  ...
                  tooltip:
                      appLocalizations.th2FileEditPageSplitLinesAtCrossings,
                ),
                TH2FileEditStateContextFABButton(
                  context: context,
                  heroTag:
                      '${heroPrefix}_ctx_join_lines_at_coinciding_extremities',
                  onPressed: th2FileEditController.hasAtLeastTwoSelectedLines
                      ? () => _onButtonPressed(
            ...
            TH2FileEditStateContextFABCategoryRow(
              buttons: <Widget>[
                ...
                TH2FileEditStateContextFABButton(
                  ...
                  onPressed: () =>
                      _onButtonPressed(MPButtonType.duplicateElements),
                  category: TH2FileEditStateContextFABCategory.clipboard,
                  icon: Icons.copy_all,
            ...
            TH2FileEditStateContextFABCategoryRow(
              buttons: <Widget>[
                TH2FileEditStateContextFABButton(
                  ...
                  icon: Icons.add_link,
                  tooltip:
                      appLocalizations.th2FileEditPageCreateMapConnectionLines,
                ),
              ],
            ),
          ],
