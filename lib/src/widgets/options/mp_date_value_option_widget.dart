...
class _MPDateValueOptionWidgetState extends State<MPDateValueOptionWidget>
    with MPOptionTypeBeingEditedTrackingMixin<MPDateValueOptionWidget> {
  late String _date;
              ...
              child: Column(
                children: [
                  RadioListTile<String>(
                    key: ValueKey(
                      "MPDateValueOptionWidget|RadioListTile|$mpUnsetOptionID",
                    ),
                  ...
                  RadioListTile<String>(
                    key: ValueKey(
                      "MPDateValueOptionWidget|RadioListTile|$mpNonMultipleChoiceSetID",
                    ),
