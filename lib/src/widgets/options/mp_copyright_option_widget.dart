...
class _MPCopyrightOptionWidgetState extends State<MPCopyrightOptionWidget>
    with MPOptionTypeBeingEditedTrackingMixin<MPCopyrightOptionWidget> {
  late String _date;
              ...
              child: Column(
                children: [
                  RadioListTile<String>(
                    key: ValueKey(
                      "MPCopyrightOptionWidget|RadioListTile|$mpUnsetOptionID",
                    ),
                  ...
                  RadioListTile<String>(
                    key: ValueKey(
                      "MPCopyrightOptionWidget|RadioListTile|$mpNonMultipleChoiceSetID",
                    ),
