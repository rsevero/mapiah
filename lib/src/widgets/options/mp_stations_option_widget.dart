...
class _MPStationsOptionWidgetState extends State<MPStationsOptionWidget>
    with MPOptionTypeBeingEditedTrackingMixin<MPStationsOptionWidget> {
              ...
              child: Column(
                children: [
                  RadioListTile<String>(
                    key: ValueKey(
                      "MPStationsOptionWidget|RadioListTile|$mpUnsetOptionID",
                    ),
                  ...
                  RadioListTile<String>(
                    key: ValueKey(
                      "MPStationsOptionWidget|RadioListTile|$mpNonMultipleChoiceSetID",
                    ),
