...
class _MPStationNamesOptionWidgetState extends State<MPStationNamesOptionWidget>
    with MPOptionTypeBeingEditedTrackingMixin<MPStationNamesOptionWidget> {
              ...
              child: Column(
                children: [
                  RadioListTile<String>(
                    key: ValueKey(
                      "MPStationNamesOptionWidget|RadioListTile|$mpUnsetOptionID",
                    ),
                  ...
                  RadioListTile<String>(
                    key: ValueKey(
                      "MPStationNamesOptionWidget|RadioListTile|$mpNonMultipleChoiceSetID",
                    ),
