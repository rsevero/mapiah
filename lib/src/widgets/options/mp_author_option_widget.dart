...
class _MPAuthorOptionWidgetState extends State<MPAuthorOptionWidget>
    with MPOptionTypeBeingEditedTrackingMixin<MPAuthorOptionWidget> {
  late String _date;
  late String _person;
              ...
              child: Column(
                children: [
                  RadioListTile<String>(
                    key: ValueKey(
                      "MPAuthorOptionWidget|RadioListTile|$mpUnsetOptionID",
                    ),
                  ...
                  RadioListTile<String>(
                    key: ValueKey(
                      "MPAuthorOptionWidget|RadioListTile|$mpNonMultipleChoiceSetID",
                    ),
