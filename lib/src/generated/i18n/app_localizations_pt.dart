...
class AppLocalizationsPt extends AppLocalizations {
  ...
  String mapiahTherionRunTHConfigFileLabel(Object fileName) {
    return 'Arquivo THConfig: $fileName';
  }
  ...
  @override
  String get mpCommandDescriptionAddEmptyLine => 'Adicionar linha vazia';
  ...
  @override
  String get mpCommandDescriptionRemoveEmptyLine => 'Apagar linha vazia';
  ...
  String get mpCommandDescriptionSimplifyToBezier =>
      'Simplificar transformando em curva Bézier';
  ...
  @override
  String get mpSettingsSettingTH2EditSymbolUnit => 'Unidade do símbolo';
  ...
  @override
  String get mpSnapTargetPointByType => 'Pontos por tipo';

  @override
  String get mpSnapTargetXVIFileGridLine => 'Linhas de grade';

  @override
  String get mpSnapTargetXVIFileGridLineIntersection =>
      'Interseções de linhas de grade';

  @override
  String get mpSnapTargetXVIFileShot => 'Medidas';

  @override
  String get mpSnapTargetXVIFileSketchLine => 'Linhas do croqui';

  @override
  String get mpSnapTargetXVIFileStation => 'Bases';
  ...
  String get mpStatusBarMessageSingleSelectedElementSelectedControlPoint =>
      ' - selecionado: ponto de controle';

  @override
  String mpStatusBarMessageSingleSelectedElementSelectedEndPoints(
    Object count,
  ) {
    return ' - selecionado(s): $count ponto(s) final(is)';
  }
  ...
  String th2FileEditPageAddAreaStatusBarMessage(Object type) {
    return 'Selecione uma linha para ser incluída como borda da nova área do tipo $type';
  }
  ...
  @override
  String get th2FileEditPageAddImageButton => 'Adicionar imagem (I)';
  ...
  String get th2FileEditPageAddLineSegments =>
      'Criar segmentos de linha entre segmentos de linha selecionados (/)';
  ...
  String th2FileEditPageAddLineToAreaStatusBarMessage(Object type) {
    return 'Selecione uma linha para ser incluída como borda da área $type selecionada';
  }
  ...
  String get th2FileEditPageConvertLineSegmentsToStraight =>
      'Converter segmentos de linha para reta (Shift+J)';

  @override
  String get th2FileEditPageCopyElements => 'Copiar elementos (Ctrl+C)';
  ...
  String get th2FileEditPageCreateMapConnectionLines =>
      'Criar linhas de conexão de mapa';

  @override
  String get th2FileEditPageCutElements => 'Recortar elementos (Ctrl+X)';

  @override
  String get th2FileEditPageCutScrapButton => 'Recortar croqui';

  @override
  String get th2FileEditPageDeselectAllElements =>
      'Desselecionar todos os elementos (Ctrl+D)';

  @override
  String get th2FileEditPageDeselectAllEndPoints =>
      'Desselecionar todos os pontos finais (Ctrl+D)';

  @override
  String get th2FileEditPageDisableImageEditModeButton =>
      'Parar de editar imagem';

  @override
  String get th2FileEditPageDuplicateElements =>
      'Duplicar elementos (Ctrl+Shift+D)';
  ...
  @override
  String get th2FileEditPageImageScaleOverlayLabel => 'Redimensionar';
  ...
  String get th2FileEditPageInteractiveSimplifyLinesKeepOriginal =>
      'Manter tipos originais dos segmentos';

  @override
  String get th2FileEditPageInteractiveSimplifyLinesMethodLabel => 'Método';
  ...
  @override
  String get th2FileEditPagePasteElements => 'Colar elementos (Ctrl+V)';
  ...
  String get th2FileEditPageSelectAllElements =>
      'Selecionar todos os elementos (Ctrl+A)';

  @override
  String get th2FileEditPageSelectAllEndPoints =>
      'Selecionar todos os pontos finais (Ctrl+A)';
  ...
  @override
  String get th2FileEditPageSimplifyLines => 'Simplificar linhas (Ctrl+L)';

  @override
  String get th2FileEditPageSimplifyLinesForcingBezier =>
      'Simplificar linhas forçando Bézier (Ctrl+Alt+L)';

  @override
  String get th2FileEditPageSimplifyLinesForcingStraight =>
      'Simplificar linhas forçando reto (Ctrl+Shift+L)';

  @override
  String get th2FileEditPageSmoothLineSegments =>
      'Ativar a opção suavizar segments de linha (S)';
  ...
  String get th2FileEditPageSplitLineAtSelectedEndPoints =>
      'Dividir linha nos pontos finais selecionados (Ctrl+P)';
  ...
  @override
  String get projectTreeCloseProjectTooltip => 'Fechar projeto';
  ...
  @override
  String get projectSearchTitle => 'Pesquisar nos arquivos';

  @override
  String get projectSearchOpenTooltip =>
      'Pesquisar nos arquivos (Ctrl/Cmd+Shift+F)';

  @override
  String get projectSearchBackToTreeTooltip => 'Voltar à árvore do projeto';

  @override
  String get projectSearchQueryHint => 'Pesquisar';

  @override
  String get projectSearchReplacementHint => 'Substituir';
  ...
  @override
  String get projectSearchToggleReplaceTooltip => 'Alternar substituição';

  @override
  String get projectSearchRefreshTooltip => 'Atualizar pesquisa';

  @override
  String get projectSearchScopeLabel => 'Escopo';

  @override
  String get projectSearchScopeOpenTabs => 'Abas de texto abertas';

  @override
  String get projectSearchScopeProjectFiles => 'Arquivos do projeto';

  @override
  String get projectSearchReplaceAllButton => 'Substituir todas';
  ...
  @override
  String get projectSearchSearching => 'Pesquisando…';

  @override
  String get projectSearchReplacing => 'Substituindo…';

  @override
  String get projectSearchEmptyQuery =>
      'Digite um texto para pesquisar em vários arquivos.';

  @override
  String get projectSearchNoOpenTabs =>
      'Nenhuma aba de texto aberta para pesquisar.';

  @override
  String get projectSearchNoProject =>
      'Abra um projeto para pesquisar seus arquivos.';

  @override
  String get projectSearchNoMatches => 'Nenhuma ocorrência encontrada.';
  ...
  @override
  String get projectSearchStandaloneIndicator => 'Somente pesquisa';

  @override
  String get projectSearchStandaloneTooltip =>
      'Este arquivo não faz parte do projeto carregado. Você pode abri-lo e navegar até as ocorrências, mas a substituição em massa não o modificará nem o salvará.';

  @override
  String get projectSearchReplaceConfirmTitle => 'Substituir todas';
  ...
  String projectSearchReplaceConfirmBody(int matchCount, int fileCount) {
    ...
    return 'Substituir $_temp0 em $_temp1? Os arquivos do projeto afetados serão salvos. Isso não pode ser desfeito como uma única ação.';
  }
  ...
  String projectSearchReplaceConfirmExcluded(int matchCount, int fileCount) {
    String _temp0 = intl.Intl.pluralLogic(
      matchCount,
      locale: localeName,
      other: '$matchCount ocorrências somente de pesquisa',
      one: '1 ocorrência somente de pesquisa',
    );
    String _temp1 = intl.Intl.pluralLogic(
      fileCount,
      locale: localeName,
    ...
    return '$_temp0 em $_temp1 não serão alteradas.';
  }

  @override
  String get projectSearchReplaceConfirmButton => 'Substituir todas';

  @override
  String get projectSearchReplaceCancelButton => 'Cancelar';

  @override
  String get projectSearchReplaceOnlyStandalone =>
      'Todas as ocorrências estão em arquivos somente de pesquisa, portanto a substituição em massa não está disponível.';

  @override
  String get projectSearchReplaceAborted =>
      'A substituição em massa foi cancelada porque os resultados da pesquisa ou o projeto mudaram. Nada foi modificado.';

  @override
  String get projectSearchReplacePreflightFailed =>
      'A substituição em massa não pôde iniciar porque um ou mais arquivos falharam nas verificações prévias. Nada foi modificado.';

  @override
  String get projectSearchReplaceCompleteTitle =>
      'Substituição em massa concluída';
  ...
  String projectSearchReplaceCompleteSummary(int matchCount, int fileCount) {
    ...
    return 'Salvas $_temp0 em $_temp1.';
  }
  ...
  String projectSearchReplaceCompleteIncomplete(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count arquivos não foram totalmente salvos',
      one: '1 arquivo não foi totalmente salvo',
    );
    return '$_temp0 porque edições mais recentes ou uma mudança de projeto interferiram.';
  }
  ...
  String projectSearchReplaceCompleteSkipped(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count arquivos foram ignorados',
      one: '1 arquivo foi ignorado',
    );
    return '$_temp0 porque seu conteúdo ou vínculo com o projeto mudou.';
  }
  ...
  String projectSearchReplaceCompleteFailed(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count arquivos não puderam ser salvos',
      one: '1 arquivo não pôde ser salvo',
    );
    return '$_temp0.';
  }
  ...
  String projectSearchReplaceCompleteMaterialized(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$count arquivos com substituições não salvas foram deixados abertos em abas de editor',
      one:
          '1 arquivo com substituições não salvas foi deixado aberto em uma aba de editor',
    );
    return '$_temp0 para recuperação.';
  }

  @override
  String get projectSearchReplaceCompleteCloseButton => 'Fechar';

  @override
  String get th2ElementTreeLoading => 'Carregando…';
  ...
  String get th2ElementTreeBrokenFile =>
      'Arquivo com problemas: corrija-o fora do Mapiah e recarregue';
  ...
  String th2ElementTreeProblemLine(int lineNumber, String detail) {
    return 'Linha $lineNumber: $detail';
  }
  ...
  @override
  String get th2ElementTreeReload => 'Recarregar';

  @override
  String get th2ElementTreeScrapContainsSelection =>
      'Contém elementos selecionados';
