...
/// Ports `l_viaferrata_SKBB`. As of this Therion source tree, that macro
...
/// with no dedicated UIS macro to fall back to instead (`l_viaferrata` is
...
/// decorator.
class MPViaFerrataSKBBLineDecorator extends MPLineDecorator {
