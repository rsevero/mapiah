...
final Map<MPTherionPointSymbol, MPTherionSymbolPaint> mpTherionSymbolPaints =
    {
      ...
      MPTherionPointSymbol.diskUIS: MPTherionSymbolPaint(
        border: THPaint.thPaint12,
      ),
      ...
      MPTherionPointSymbol.guanoUIS: MPTherionSymbolPaint(
        border: THPaint.thPaint8,
      ),
      MPTherionPointSymbol.helictiteUIS: MPTherionSymbolPaint(
        border: THPaint.thPaint5,
      ),
      MPTherionPointSymbol.iceUIS: MPTherionSymbolPaint(
      ...
      MPTherionPointSymbol.sandUIS: MPTherionSymbolPaint(
        border: THPaint.thPaint1,
      ),
