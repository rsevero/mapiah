...
const int mpInteractiveLineSimplificationInitialIntensity = 1;
const int mpInteractiveLineSimplificationMaxIntensity = 40;
...
const double mpTherionUISSandDotRadiusUnits = 0.025;
...
const double mpDragDropIndicatorHeight = 10.0;
const double mpDragFeedbackOpacity = 0.8;
const double mpButtonSpace = 8;
const double mpDefaultButtonRadius = 8;
const double mpButtonMargin = mpButtonSpace * 4;
const double mpResponsiveAppBarExpandedActionsMinWidth = 600;
const double mpResponsiveAppBarOverflowMenuMinWidth = kMinInteractiveDimension;
...
const String mpLastUsedAreaLineAreaPrefix = 'area';
const String mpLastUsedAreaLineLinePrefix = 'line';
...
const int mpMapiahCommitsAPIMaxPages = 50;
...
const String mpHttpHeaderAcceptEncoding = 'Accept-Encoding';
const String mpHttpHeaderAcceptEncodingGzip = 'gzip';
...
const double mpProjectTreeDropZoneHalfFraction = 0.5;
const int mpProjectTreeDragHoverExpandDelayMilliseconds = 700;
