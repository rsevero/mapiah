...
class MPTH2FileEditStateEditSingleLine extends MPTH2FileEditState
  ...
  Future<void> onPrimaryButtonClick(PointerUpEvent event) async {
    ...
    /// This check needs to happen here because the multiple elements clicked
    /// dialog generated by getSelectableElementsClickedWithDialog below might
    /// have been dismissed by clicking in the empty space and that last click
    /// will still be processed by this state but after that click there will
    /// be no selected elements, or at least not the single line that this state
    /// depends on.
    if (!selectionController.isSingleLineSelected()) {
      return;
    }
