...
mixin MPTH2FileEditStateKeyDownMixin on MPTH2FileEditState {
  @override
      ...
      case LogicalKeyboardKey.keyK:
        if (!isCtrlPressed && !isMetaPressed && !isShiftPressed) {
          ...
          if (!isAltPressed && !isShiftPressed) {
            ...
            if (context == null) {
              throw Exception(
                'At MPTH2FileEditStateKeyDownMixin._onKeyDownEvent() keyK: unable to get TH file widget context to show help dialog.',
              );
            }
