...
O comportamento exato desse arrasto depende da opção de configuração "Método de criação de nova linha". "Quadrático do Mapiah" mantém o comportamento atual descrito abaixo e também permite manter _Shift_ pressionado durante o arrasto para restringir o ponto de controle ao múltiplo mais próximo do ângulo de snap configurado em relação ao nó compartilhado. "Cúbico suave do xTherion" usa a posição arrastada como o futuro ponto de controle do próximo segmento, espelha o outro ponto de controle do segmento atual em torno do ponto final compartilhado e permite manter _Ctrl_ pressionado durante o arrasto para fixar a distância do ponto de controle espelhado. Ao definir esse ponto de controle no modo "Cúbico suave do xTherion", você também pode manter _Shift_ pressionado durante o arrasto para restringi-lo ao múltiplo mais próximo do ângulo de snap configurado em relação ao nó compartilhado. Essa restrição por _Shift_ também pode ser combinada com _Alt_ no modo "Cúbico suave do xTherion".
...
Ao desenhar com "Cúbico suave do xTherion", você pode pressionar _Esc_ para excluir todo o caminho inacabado e iniciar um novo.
