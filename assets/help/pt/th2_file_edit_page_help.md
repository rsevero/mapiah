...
### Canto superior direito <a id="top-right-corner"></a>
...
### Canto inferior direito <a id="bottom-right-corner"></a>
...
### Formato original do arquivo <a id="original-file-format"></a>
...
### Versões web <a id="web-releases"></a>
...
## Simplificar linhas <a id="simplify-lines"></a>
...
### Métodos de simplificação <a id="simplification-methods"></a>
...
### Segmentos de linha em curva Bézier <a id="bézier-curve-line-segments"></a>
...
### Segmentos de linha mistos <a id="mixed-line-segments"></a>
...
### Segmentos de linha reta <a id="straight-line-segments"></a>
...
## Zoom e pan <a id="zoom-and-panning"></a>
