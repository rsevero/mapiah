...
| Delete an unfinished path while drawing                                          | Esc                                        |
| Delete last created node while drawing                                           | Del or Backspace                           |
...
| Move selected image / elements / end-control points by nudge factor              | Arrow                                      |
...
| Run Therion                                                                      | T                                          |
| Save file                                                                        | Ctrl+S                                     |
| Save file as (`.th2` canvas or `thconfig`/`.th` text tab)                        | Ctrl+Shift+S                               |
