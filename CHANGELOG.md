...
* Infrastructure maintenance:
  ...
  * Extracted dedicated TH2 edit widgets for the bottom status bar and the last-used PLA button strip, reducing `TH2FileEditBodyWidget` size and keeping those canvas overlays self-contained.
