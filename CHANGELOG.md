...
* Infrastructure maintenance:
  ...
  * Home page: increased font size of the initial page presentation text to headlineMedium.
  * Telemetry consent dialog body is now loaded from locale-aware markdown assets (assets/help/{locale}/telemetry_consent.md) and rendered with MarkdownBlock, replacing the plain localization string. Falls back to the localization string if the asset cannot be loaded.
