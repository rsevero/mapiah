...
* Fixed bugs:
  ...
  * The bottom strip of last-used PLA type buttons no longer overflows when many point types are present; each side now scrolls horizontally and accepts desktop mouse drag and wheel/trackpad input so hidden point buttons remain reachable.
