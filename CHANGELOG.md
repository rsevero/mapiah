...
* Infrastructure maintenance:
  * Refactored `MPImageInsertConfig` string decoding into a shared base `fromString` constructor, and updated the raster/XVI `fromString` constructors plus regression tests to reuse that common parsing path.
