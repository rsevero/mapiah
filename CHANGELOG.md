...
* Fixed bugs:
  * Slope lines whose line segments do not define any `l-size` are now painted with a dedicated special border, matching the existing visual treatment used for invisible elements and elements with THID set, with regression coverage.
