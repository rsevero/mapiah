...
The installation instructions, complete help pages, and keyboard shortcut sheets are available as PDFs in the repository root: [View the English user guide](https://cdn.jsdelivr.net/gh/rsevero/mapiah@main/Mapiah-User-Guide-en.pdf) and [view the Portuguese user guide](https://cdn.jsdelivr.net/gh/rsevero/mapiah@main/Mapiah-Guia_do_usuario-pt.pdf). Each release also includes both PDFs as downloadable assets.
